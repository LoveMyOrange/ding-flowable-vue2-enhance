...
public interface BpmModelConvert {
    ...
    default List<BpmModelPageItemRespVO> convertList(List<BpmModelPlusDO> list, Map<Long, BpmFormDO> formMap,
    ...
    default BpmModelPageItemRespVO convert(BpmModelPlusDO model, BpmFormDO form, Deployment deployment, ProcessDefinition processDefinition) {
