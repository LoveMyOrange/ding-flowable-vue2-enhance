**兄弟们,虽然Ruoyi-vue-Pro 是MIT协议, 为防止各种白嫖党改名售卖, 已经修改为Apache2.0 
但是希望诸位拿到代码之后 不要改个包名就说自己研发了一个所谓的 Camunda 低代码平台,然后在网上售卖 
我可丢不起这人 这不妥妥骗人呢吗 别做这样的人,为同行所不齿!
目前本项目精华代码, 在找人逻辑那块, Camunda全网目前找不到我这这种找人方式
**
