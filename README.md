...
### 4>任何个人需要集成本项目并以此来售卖,请粘贴本项目LINCENSE_补充协议到各自项目中,否则视为侵权

### 5>任何国家机关以及公益机构以及学校对本项目可以无限制使用,本人愿意无偿提供其集成以及探讨问题,算是为国家出一份自己微薄的力量   

### 6>当然,如果做工作流的,当然都知道,后端才是本项目的重点,特别是json转bpmn的那里 ,
### 有些缺德的公司/个人倒是有可能直接把后台借鉴进去,这样就不受GPL3.0协议的限制了,
### 对于这个,我只能说是道德问题,我无法要求你们,
...
### 本项目前端并不是本人开发,是码云上的开源项目  为方便本项目 本项目维护一份此项目的前端源码保留原有协议以及作者版权印记
### 开源地址为: https://gitee.com/willianfu/jw-workflow-engine  
  
### -------注意:-------->

### 本项目后台不开放PR,也不开放新功能收集,光提issue就行了,   
...
#### 感谢如下开源项目
##### https://gitee.com/willianfu/jw-workflow-engine 提供了前端源码 保留版权信息 Apache2.0协议  
##### https://gitee.com/willianfu/jw-workflow-engine-server 提供了几个用户,部门表结构  Apache2.0协议  
#### 感谢如下个人  
...
### 本项目也有Activiti/Camunda版本,此两个版本暂不开源.但JSON-转BPMN部分代码 Activiti567均可以完全照搬 也是可以做到的    

### 本项目也有Ativiti5,6,7,Flowable5,6,Camunda7 的真正商业版本,功能比开源版更多,且重写了部分工作流框架源码进行优化,如有需要,可以联系我微信    

### 本人接公司培训工作流兼职  可以培训 如下内容: Activiti5,6,7,Flowable5,6,Camunda7 这些框架 或技术支持   
### 如有公司需要培训工作流框架,可以联系我  

### 过段时间之后可能会根据当前这个项目 做一个付费课程  讲本项目的核心源码以及如何和业务打通 属于是真正的实战课程了 全网唯一的纯实战

### 当前项目从工作流角度来讲是一个好东西,但是并没有和业务打通 这算是一个点 交给你们自行弄或者群里讨论也可以的
...
<img src="https://jeecgdev.oss-cn-beijing.aliyuncs.com/upload/wxq_1665560813427.jpg" alt="微信群" style="zoom:20%;" />
<img src="https://jeecgdev.oss-cn-beijing.aliyuncs.com/upload/qq_1665560866164.jpg" alt="QQ群" style="zoom:20%;" />
<img src="https://jeecgdev.oss-cn-beijing.aliyuncs.com/upload/zfb_1665560885522.jpg" alt="打赏" style="zoom:20%;" />
<img src="https://jeecgdev.oss-cn-beijing.aliyuncs.com/upload/wxsk_1665560942304.jpg" alt="打赏" style="zoom:20%;" />
