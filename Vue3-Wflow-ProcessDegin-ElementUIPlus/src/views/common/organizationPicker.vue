      ...
      <div>
        ...
        <div class="box">
          ...
          <div style="margin-top: 8px; width: 100%">
            ...
            >
              <div
                v-for="(node, index) in search === '' ? nodes : searchUsers"
                :key="index"
                class="line"
                :style="
...
<style>
.CNodeConfigDialog .el-dialog__body {
  padding: 0px !important;
}
.CNodeConfigDialog .el-dialog__header {
  background: #f7f7f7;
  margin-right: 0;
}
</style>
